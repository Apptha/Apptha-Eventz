...
function iColorShow(i,i2){
	...
	jQuery("#izzyColorBg").css({'opacity':'0.6','filter':'alpha(opacity=60)','z-index':'9997','position':'fixed','top':0,'left':0,'width':'100%','height':'100%'}).fadeIn("fast");
...
this.izzyColor=function(){
	...
	jQuery("input.izzyColor").each(function(i){
		...
		.after('<a href="javascript:void(null)" id="icp_'+this.id+'" onclick="iColorShow(\''+this.id+'\',\'icp_'+this.id+'\')"><img src="'+imageUrl+'" style="border:0;margin:5px 0 0 3px" align="absmiddle" ></a>')
